 ...
 * @NotThreadSafe
 */
public class IModdedZipArchiveOutputStream extends ArchiveOutputStream {
     ...
     * written in UTF-8.
     * @deprecated use {@link org.apache.commons.compress.archivers.zip.GeneralPurposeBit#UFT8_NAMES_FLAG} instead
     */
    @Deprecated
     ...
     */
    public IModdedZipArchiveOutputStream(OutputStream out) {
        this.out = out;
        this.raf = null;
    }
     ...
     */
    public IModdedZipArchiveOutputStream(File file) throws IOException {
        OutputStream o = null;
     ...
     * #IModdedZipArchiveOutputStream(java.io.File) File-arg constructor}) -
    ...
    public void putArchiveEntry(ArchiveEntry archiveEntry, File modded) throws IOException {
        if (finished) {
            throw new IOException("Stream has already been finished");
        }
        ...
        writeLocalFileHeader(entry.entry, modded);
    }
    ...
    public void write(byte[] b, int offset, int length) throws IOException {
        ZipUtil.checkRequestedFeatures(entry.entry); // ::replace this line
    ...
    protected void writeLocalFileHeader(ZipArchiveEntry ze) throws IOException {
        writeLocalFileHeader(ze, null);
    }
    protected void writeLocalFileHeader(ZipArchiveEntry ze, File modded) throws IOException {
        ...
        if (modded != null) {
            writeOut(ZipShort.getBytes(name.limit() + size));// ::replace
        } else {
     ...
     * @throws IOException on error
     */
    public final void writeOut(byte[] data, int offset, int length)
            throws IOException {
        if (raf != null) {
