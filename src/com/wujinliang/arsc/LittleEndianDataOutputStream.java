...
public class LittleEndianDataOutputStream extends FilterOutputStream {
    ...
    protected RemovableByteArrayOutputStream out;
     ...
     */
    public LittleEndianDataOutputStream(RemovableByteArrayOutputStream out) {
        super(out);
        this.out = out;
    }
     ...
     * @exception  java.io.IOException  if the underlying stream throws an IOException.
     */
    ...
    public void writeIntByBigEndian(int val) throws IOException {
     ...
     * @exception  java.io.UTFDataFormatException if the string is longer than
     *             65,535 characters.
     * @exception  java.io.IOException  if the underlying stream throws an IOException.
     */
