...
public class StringBlock {
	 ...
	 */
	public static brut.androlib.res.decoder.StringBlock read(ExtDataInput reader) throws IOException {
		...
		brut.androlib.res.decoder.StringBlock block = new brut.androlib.res.decoder.StringBlock();
	...
	private static final CharsetDecoder UTF8_DECODER = Charset.forName("UTF-8")
			.newDecoder();
	private static final Logger LOGGER = Logger.getLogger(brut.androlib.res.decoder.StringBlock.class
			.getName());
